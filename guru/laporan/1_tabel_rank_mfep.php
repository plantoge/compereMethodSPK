	...
	<table class="w100 border" style="text-align: center;">
		...
		<tr>
			...
			if ($dt_sum["tne"] >= 5) {$saran = "Di Panggil Orang Tua Dan Membuat Surat Perjanjian";}
			elseif($dt_sum["tne"] > 4 ){$saran = "Di Panggil Orang Tua Dan Diberi Nasehat";}
			elseif($dt_sum["tne"] > 3 ){$saran = "Diberi Nasehat Oleh Guru BK Dan Membuat Surat Perjanjian";}
			elseif($dt_sum["tne"] > 2 ){$saran = "Diberi Nasehat Oleh guru BK dan diberi hukuman";}
	...
	<div class="menu_print">
		<ul>
			<li>
				<a href="laporan/2_report_mfep.php" target="blank_">
